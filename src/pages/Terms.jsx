      ...
      {/* <section className="space-y-12">
        ...
        <div>
          ...
          <p className="text-sm text-primary ">
            ...
            CONTAINED WITHIN IT IN ANY MANNER. <br />
            <br />
            ...
            share with us. The information collected from you by the Company may
            ...
            time to time as we deem fit, without any intimation to you, and your
            continued use of the site will signify your acceptance of any
            amendment to these terms. <br />
            ...
            modifications or amendments to the Terms, you may terminate your use
            of this Website immediately. <br />
            We are committed to keeping all such sensitive data/information safe
            at all times and ensure that such data/information is only
            transacted over secure Site of approved payment gateways which are
            digitally encrypted, and provide the highest possible degree of care
            available under the technology presently in use. <br />
            <br />
            The Company will not use your financial information for any purpose
            other than to complete a transaction with you. <br />
            <br />
            To the extent possible, we provide you the option of not divulging
            any specific information that you wish for us not to collect, store
            or use. You may also choose not to use a particular service or
            feature on the Site, and opt out of any non-essential communications
            from the Company. <br />
            <br />
            ...
            activity or where your account has/may have been compromised. <br />
            <br />
            <span className="text-secondary">
              NOTIFICATION OF MODIFICATIONS AND CHANGES TO THE T&C AND PRIVACY
              POLICY
            </span>
            <br />
            Third party vendors including google.com (“Google”) may use cookies
            to serve ads based on your visits to this Website. You may visit the
            Website of the third party and choose to opt out of the use of
            cookies for interest-based advertising, if the third party offers
            such an option. You may choose to opt-out of the DoubleClick cookie
            that Google and its partners use for interest-based advertising by
            visiting Ads Settings. (Alternatively, you can direct users to opt
            out of a third-party vendor's use of cookies for interest based
            advertising by visiting aboutads.info.) <br />
            <br />
            ...
            <br />
            <br />
            <span className="text-secondary">INFORMATION WE COLLECT</span>
            <br />
            Your information is regarded as confidential and therefore will not
            be divulged to any third party, unless if legally required to do so
            to the appropriate authorities. <br />
            <br />
            We will not sell, share, or rent your personal information to any
            third party except our parent company, their subsidiaries/affiliates
            and/or our subsidiaries/affiliates, as applicable, or use your
            e-mail address for unsolicited mail. Any emails sent by us will only
            be in connection with the provision of agreed services and products.{' '}
            <br />
            <br />
            The Company makes all User information accessible to its employees,
            agents or partners and third parties only on a need-to-know basis,
            and binds only its employees to strict confidentiality obligations.`{' '}
            <br />
            <br />
            <span className="text-secondary">
            ...
            you submitted each time except your display name. If you change any
            information we may keep track of your old information. You can
            change your registration information such as: name, address, city,
            state, zip code, country, phone number, and profile. <br />
            <br />
            ...
            identifiable information will be completely removed from our
            databases in response to your requests. <br />
            <br />
            <span className="text-secondary">CONTROL OF YOUR PASSWORD</span>
            <br />
            ...
            password carefully, and keeping your password and computer secure by
            signing out after using our services. <br />
            <br />
            ...
            to any third party. If you choose to share this information with
            third parties to provide you additional services, you are
            responsible for all actions taken with your login information and
            password and therefore should review each third party's privacy
            policy. You are responsible for all actions taken with your login
            ...
            identifiable information and may be subject to legally binding
            actions taken on your behalf. Therefore, if your password has been
            compromised for any reason, you should immediately change your
            ...
            password even after changing it. <br />
            <br />
            <span className="text-secondary">
            ...
            third parties, you are subject to ask questions before you disclose
            your personal information to others. <br />
            <br />
            ...
            outside the company. We do not recommend transfer of sensitive
            information (such as credit card number) and bank account details
            via the Site to other Users. Users are recommended to do so offline,
            on the phone or via personal emails. We follow generally accepted
            industry standards to protect the personal information submitted to
            us, both during transmission and once We receive it. However,
            "perfect security" does not exist on the Internet. You therefore
            agree that any security breaches beyond the control of our standard
            security procedures are at your sole risk and discretion. <br />
            <br />
            <span className="text-secondary">DISPUTES AND JURISDICTION </span>
            <br />
            All disputes involving but not limited to rights conferred,
            compensation, refunds, and other claims through this policy will be
            ...
            mediator by both parties. Both parties may raise a name for sole
            arbitrator and in case both parties accept the proposed name, the
            said person shall be appointed as sole mediator. In any case the
            parties are not able to reach a consensus within two proposed
            ...
            parties, however the parties in good faith will attempt to bind by
            the decision. <br /> Stage 2: Arbitration: In case that mediation
            does not yield a result suitable or preferred by any one of the
            parties, arbitration may follow, the award of which is binding on
            both parties. The Arbitration Board shall comprise three members â€“
            one appointed by each party and the third member to be nominated by
            the two appointed members by mutual consent. Arbitration shall be
            held at Delhi, India. The proceedings of arbitration shall be in the
            ...
            Alternate Dispute Resolution mechanism, it shall be referred to the
            courts at Delhi, India. <br />
            <br />
            <span className="text-secondary">
              QUESTIONS AND SUGGESTIONS AND GRIEVANCE OFFICER{' '}
            </span>
            <br />
            In case you have concerns that are not resolved by our Customer Care
